...
int main() {
    ...
    // load anim stf
    float charWaitTime =
        0.1f;  // animation per frame time also growth for plants
    ...
    UI tomatoesBackground("scrollsandblocks.png", sf::Vector2f(1300.f, 288.f),
                          2, sf::IntRect(0, 0, 32, 32));
    UI blueberriesButton("crops2.png", sf::Vector2f(1300.f, 388.f), 2,
                         sf::IntRect(32 * 23, 32 * 10, 32, 32));
    UI blueberriesBackground("scrollsandblocks.png",
                             sf::Vector2f(1300.f, 388.f), 2,
    ...
    UI strawberriesBackground("scrollsandblocks.png",
                              sf::Vector2f(1300.f, 688.f), 2,
                              sf::IntRect(0, 0, 32, 32));
    ...
    signs.setPosition(win.getSize().x / 2 - 687,
                      signsPlacement.height / 2 - 100);  // -458 * 1.5
    ...
    signs2.setPosition(win.getSize().x / 2 - 687,
                       signsPlacement2.height / 2 + 100);  // +50 * 1.5
    ...
    signs3.setPosition(win.getSize().x / 2 - 687,
                       signsPlacement3.height / 2 + 200);  // +150 * 1.5
    ...
    signs4.setPosition(win.getSize().x / 2 - 679.5,
                       signsPlacement4.height / 2 + 300);  // +250 * 1.5
    ...
    signs5.setPosition(win.getSize().x / 2 - 687,
                       signsPlacement5.height / 2 + 400);  // +357 * 1.5
        ...
        while (win.pollEvent(event)) {
            ...
            if (event.type == Event::MouseButtonPressed) {
                if (event.mouseButton.button == Mouse::Left) {
                    ...
                    if (sc.getGlobalBounds().contains(
                            static_cast<Vector2f>(mouseposf))) {
                        isUpgrade1 = true;
            ...
            if (mh.handleMouse(event, signs,
                ...
                if (funds >= 10) {
                    ...
                    avoGrowth(funds, fundsInString, money, win, blueberryClock,
                              isAvo, avoModifier);  // calls function
                }
            }
            if (mh.handleMouse(event, signs2, win)) {
                if (funds >= 50) {
                    ...
                    isBeet = true;
                    beetClock.restart();
                    beetGrowth(funds, fundsInString, money, win, beetClock,
                               beetModifier, isBeet);
                }
            };
            ...
            if (tomatoesBackground.getWithinDimensions(
                ...
                if (sf::Mouse::isButtonPressed(sf::Mouse::Left) &&
                    ...
                    tomatoesBackground.buttonPressed(
                        0);  // Changes button texture
                    plantTomatoes = true;
                    plantCrop = true;
                }
            }
            ...
            if (beetsBackground.getWithinDimensions(beetsBackground,
                                                    worldPosition)) {
                if (sf::Mouse::isButtonPressed(sf::Mouse::Left) &&
                    grid.checkGrid() == true) {
            ...
            if (strawberriesBackground.getWithinDimensions(
                    strawberriesBackground, worldPosition)) {
                if (sf::Mouse::isButtonPressed(sf::Mouse::Left) &&
                    grid.checkGrid() == true) {
            ...
            if (shopBackground.getWithinDimensions(shopBackground,
                                                   worldPosition) &&
            ...
            if (cropBackground.getWithinDimensions(cropBackground,
                                                   worldPosition) &&
                sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
            ...
            if (moreBackground.getWithinDimensions(moreBackground,
                                                   worldPosition) &&
                sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
                ...
                if (worldPosition.x >= gridOffsetX &&
                    ...
                    grid.updateMouseGridPosition(
                        worldPosition, mousePosGrid);  // Update grid position
                    grid.updateTileSelector(
                        mousePosGrid, plantCrop);  /// Update tile selection
                    if (sf::Mouse::isButtonPressed(sf::Mouse::Left) &&
                        ...
                        if (grid.getIsLocked(mousePosGrid) == false &&
                            ...
                            Crop* newBlueberries = new Blueberries(
                                {mousePosGrid.x * gridSizeF + gridOffsetX,
                        ...
                        if (grid.getIsLocked(mousePosGrid) == false &&
                            grid.getHasCrop(mousePosGrid) == false) {
                            Crop* newStrawberries = new Strawberries(
                                {mousePosGrid.x * gridSizeF + gridOffsetX,
                                 mousePosGrid.y * gridSizeF + gridOffsetY});
                ...
                if (p.getCharPosition().x > gridSizeF * mapSizeX) {
                    p.setCharPosition(gridSizeF * mapSizeX,
                                      p.getCharPosition().y);
                }
            ...
            // flags
            if (isBeet == true) {
                if (beetClock.getElapsedTime().asMilliseconds() >=
                    beetModifier) {
                    beetGrowth(funds, fundsInString, money, win, beetClock,
                               beetModifier, isBeet);
                }
            ...
            if (isAvo == true) {
                if (blueberryClock.getElapsedTime().asMilliseconds() >=
                    avoModifier) {
                    avoGrowth(funds, fundsInString, money, win, blueberryClock,
                              isAvo, avoModifier);
                }
            ...
            if (isApple == true) {
                if (tomatoClock.getElapsedTime().asMilliseconds() >=
                    appleModifier) {
                    appleGrowth(funds, fundsInString, money, win, tomatoClock,
                                appleModifier, isApple);
                }
            ...
            if (isBanana == true) {
                if (carrotClock.getElapsedTime().asMilliseconds() >=
                    bananaModifier) {
                    bananaGrowth(funds, fundsInString, money, win, carrotClock,
                                 bananaModifier, isBanana);
                }
            ...
            if (isCherry == true) {
                if (strawberryClock.getElapsedTime().asMilliseconds() >=
                    cherryModifier) {
                    appleGrowth(funds, fundsInString, money, win,
                                strawberryClock, cherryModifier, isCherry);
                }
            }
