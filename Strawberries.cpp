...
void Strawberries::Draw(sf::RenderTarget& rt) {
    rt.draw(sprite);
};

void Strawberries::Update(float dt, float waitTime, bool resetFrame, Player& player) {
...
float Strawberries::getGrowthTime() {
    return waitTime;
}
