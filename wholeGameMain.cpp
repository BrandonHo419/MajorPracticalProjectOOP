...
int main() {
  ...
  Text gameInstruction("windows_command_prompt.ttf", sf::Vector2f(1240.f, 515.f), 30);
   ...
   gameInstruction.updateTextInstructions("crop growth time and the sale value.");
  ...
  UI fertiliserIcon("crops2.png", sf::Vector2f(1695.f, 430.f), 2, sf::IntRect(16*6, 16*7, 16, 16));
